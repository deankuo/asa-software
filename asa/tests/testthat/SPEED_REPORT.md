...
**Last Run:** 2026-01-30 10:46:39 CST
**Overall Status:** PASS
...
|-----------|---------|----------|-----------|-------|--------|
| build_prompt | 0.1797s | 0.09s | 0.36s | 2.00x | PASS |
| helper_funcs | 0.1188s | 0.07s | 0.28s | 1.70x | PASS |
| combined | 0.1654s | 0.09s | 0.36s | 1.82x | PASS |
| agent_search | 21.9s | 18s | 70s | 1.25x | PASS |
