...
**Last Run:** 2026-02-03 15:19:41 CST
**Overall Status:** PASS
...
|-----------|---------|----------|-----------|-------|--------|
| build_prompt | 0.1301s | 0.09s | 0.36s | 1.45x | PASS |
| helper_funcs | 0.0788s | 0.07s | 0.28s | 1.13x | PASS |
| combined | 0.1138s | 0.09s | 0.36s | 1.25x | PASS |
