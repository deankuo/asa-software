...
**Last Run:** 2026-02-04 16:48:29 CST
**Overall Status:** PASS
...
|-----------|---------|----------|-----------|-------|--------|
| build_prompt | 0.0783s | 0.09s | 0.36s | 0.87x | PASS |
| helper_funcs | 0.0440s | 0.07s | 0.28s | 0.63x | PASS |
| combined | 0.0685s | 0.09s | 0.36s | 0.75x | PASS |
| agent_search | 41.9s | 18s | 70s | 2.38x | PASS |
