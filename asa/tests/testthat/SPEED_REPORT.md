...
**Last Run:** 2026-02-06 15:21:11 CST
**Overall Status:** PASS
...
|-----------|---------|----------|-----------|-------|--------|
| build_prompt | 0.0974s | 0.09s | 0.36s | 1.08x | PASS |
| helper_funcs | 0.0483s | 0.07s | 0.28s | 0.69x | PASS |
| combined | 0.0731s | 0.09s | 0.36s | 0.80x | PASS |
