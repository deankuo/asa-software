...
<!-- SPEED_REPORT_START -->
**Last Run:** 2026-01-30 10:46:39 CST | **Status:** PASS

| Benchmark | Current | Baseline | Ratio | Status |
|-----------|---------|----------|-------|--------|
| `build_prompt` | 0.180s | 0.09s | 2.00x | PASS |
| `helper_funcs` | 0.119s | 0.07s | 1.70x | PASS |
| `combined` | 0.165s | 0.09s | 1.82x | PASS |
| `agent_search` | 21.9s | 18s | 1.25x | PASS |
